...
namespace IUDICO.UnitTest.Functional
{
    ...
    public class StudentTests : TestFixtureWeb
    {
        ...
        [Test]
        public void SeeTheory1()
        {
            string name = "TestUser39";
        ...
        [Test]
        public void WactingResult1()
        {
            string name = "TestUser319";
