...
namespace IUDICO.DataModel.DB
{
    ...
    partial void DeleteTblVarsScore(TblVarsScore instance);
		...
		public System.Data.Linq.Table<TblBob> TblBob
		{
			get
			{
				return this.GetTable<TblBob>();
			}
		}
	...
	[Table(Name="dbo.tblBob")]
	public partial class TblBob
	{
		...
		[Column(Storage="_Pattern", DbType="VarChar(MAX) NOT NULL", CanBeNull=false, UpdateCheck=UpdateCheck.Never)]
