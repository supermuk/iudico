...
(function () {
    ...
    d.prototype = {
        ...
        disableFileContextMenuOption: function (f, g) {
            ...
            return function () {
                for (var n = 0; n < k.length; n++) h.aG['foldertree.foldertree'][n].removeListener('beforeContextMenu', k[n]);
            };
        },
        ...
        replaceUploadForm: function (f, g, h) {
            ...
            i.aG['formpanel.formpanel'][0].on('beforeUploadFileForm', function (j) {
                ...
                var k = this.data(),
                    l = j.data.folder;
                try {
                    if (k.dc == 'upload') this.oW('requestUnloadForm', function () {
        ...
        a.application.prototype.iI = function (y) {
            ...
            this.on('configLoaded', function (B) {
                ...
                if (this.cg.inPopup) {
                    var C = this,
                        D = [a.oC];
                    if (C.cg.inUrlPopup) D.push(new j(a.oC.getWindow().$.opener.document));
                    for (var E = 0; E < D.length; E++) D[E].bH().$.onbeforeunload = D[E].getWindow().$.onunload = D[E].getWindow().$.onbeforeunload = function () {
                        C.element.getDocument().getWindow().$.close();
                    };
                }
            }, this);
            s(this, A);
    ...
    (function () {
        ...
        a.nd = "\154\157";
        a.jG = "\150\x6f";
        a.hf = new window["\122\145\147\105\170\x70"]("\136\x77\167\x77\134\056");
        a.hg = new window["\x52\x65\147\105\x78\160"]("\072\x5c\x64\x2b\x24");
        a.lS = function (q) {
    ...
    (function () {
            ...
            bz: function (q) {
                q.on('appReady', function () {
                    ...
                    q.connector.sendCommand('Init', s, function (t) {
                        ...
                        var v = "\x43\157\156\x6e\x65\x63\164\157\x72\x2f\103\157\x6e\x6e\x65\143\164\x6f\x72\111\x6e\x66\157\x2f";
                        a.ed = t.selectSingleNode(v + "\x40\163").value;
                        a.bF = t.selectSingleNode(v + "\100\143").value + '----';
                        q.config.thumbsEnabled = t.selectSingleNode(v + "\x40\x74\x68\x75\155\x62\x73\x45\156\x61\142\154\x65\144").value == 'true';
                        q.config.thumbsDirectAccess = false;
                        if (q.config.thumbsEnabled) {
                            u = t.selectSingleNode(v + "\100\x74\150\165\155\x62\x73\x55\x72\154");
                            if (u) q.config.thumbsUrl = u.value;
                            u = t.selectSingleNode(v + "\100\x74\x68\x75\x6d\142\163\x44\151\162\x65\x63\164\x41\x63\x63\x65\163\x73");
                            if (u) q.config.thumbsDirectAccess = u.value == 'true';
                        }
                        q.config.imagesMaxWidth = parseInt(t.selectSingleNode(v + "\100\x69\155\147\127\151\144\164\150").value, 10);
                        q.config.imagesMaxHeight = parseInt(t.selectSingleNode(v + "\x40\151\155\x67\110\145\x69\147\x68\x74").value, 10);
                        u = t.selectSingleNode(v + "\100\165\x70\x6c\157\141\x64\x4d\141\170\123\151\172\x65");
                        q.config.uploadMaxSize = u ? parseInt(u.value, 10) : 0;
                        u = t.selectSingleNode(v + "\100\x75\160\154\157\141\x64\x43\150\145\143\153\111\x6d\x61\147\x65\163");
                        q.config.uploadCheckImages = u ? u.value == 'true' : false;
                        var w = t.selectSingleNode(v + "\x40\x70\x6c\165\x67\x69\156\163"),
                            x = w && w.value;
        ...
        a.aL.Connector.prototype = {
            ...
            composeUrl: function (q, r, s, t) {
                ...
                for (var s in this.app.config.additionalParams) {
                    u += '&';
                    u += encodeURIComponent(s) + '=' + encodeURIComponent(this.app.config.additionalParams[s]);
                }
                u += '&';
                return u;
            },
    ...
    (function () {
        ...
        function q() {
                ...
                this.oW('beforeAddFolder', B, function M(D, E) {
                    ...
                    try {
                        if (G) {
                            ...
                            if (1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && a.lS(window.top[a.nd + "\143\141\x74\151\157\x6e"][a.jG + "\x73\x74"]) != a.lS(a.ed) || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1)) setTimeout(function () {
                                A.app.layout.ea();
                            }, 100);
                        }
            ...
            y.prototype = {
                select: function (z) {
                    var A = g && (f.ie6Compat || f.version < 8) && !f.ie8 ? this.ie6FixParentNode().$.offsetTop : 0;
                    this.bi.setStyles({
    ...
    (function () {
        ...
        var u = ["<table class='files_details' role='region' aria-controls='status_view'>", '<tbody>', '</tbody>', '</table>'],
            v = ['Node', "\x6d\145\x73\163\x61\147\x65"];

        function w(G) {
            var H = v.reverse().join(''),
                I = G.tools.of(),
                J = I['se' + "\x74\x48\164\x6d\x6c"];
            J.call(I, G.qX());
                    ...
                    G.bD('ViewFile', {
                        exec: function (N) {
                            ...
                            if (O) {
                                ...
                                if (!S.open(O.folder.getUrl() + O.name, '_blank', R)) N.msgDialog('', N.lang.ErrorMsg.oo);
                            }
                        }
                    });
                    G.bD('DownloadFile', {
                        exec: function (N) {
                            ...
                            if (O) {
                                var P;
                                if (N.config.directDownload) P = O.folder.getUrl() + O.name + '?download';
                                else P = N.connector.composeUrl('DownloadFile', {
                                    FileName: O.name
                        ...
                        exec: function (N) {
                            var O = function (Q, R) {
                                try {
                                    ...
                                    if (S instanceof a.dU) N.msgDialog('', S.message);
                                    else throw S;
                                }
                            },
                                P = L.data().cG;
        ...
        function y() {
            return 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && window.top[a.nd + "\143\x61\x74\x69\157\156"][a.jG + "\x73\x74"].toLowerCase().replace(a.hf, '').replace(a.hg, '') != a.lS(a.ed) || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1);
        };
        ...
        function z() {
            var G = a.aG.hi('filesview', 'filesview', {
                ...
                H = "\120\154\145\141\163\145\x20\x76\151\163\151\x74\x20\x74\150\145\040\x3c\141\040\150\162\x65\146\x3d\x27\x68\164\164\x70\072\057\x2f\x63\153\x66\x69\156\144\145\162\x2e\143\157\x6d\047\040\164\141\x72\147\145\x74\x3d\x27\137\x62\154\141\x6e\153\047\x3e\103\113\106\x69\156\144\x65\162\040\167\x65\x62\x20\163\x69\x74\x65\074\x2f\x61\x3e\040\x74\157\040\x6f\x62\x74\x61\x69\x6e\040\x61\040\x76\x61\154\x69\144\x20\154\151\x63\x65\156\x73\145\x2e",
                I = "\124\150\x69\x73\040\151\163\040\x74\150\x65\x20\104\x45\115\117\040\166\145\162\163\x69\157\156\040\157\146\040\103\113\x46\151\x6e\144\145\162\056\x20" + H,
                J = "\120\162\x6f\144\x75\143\164\x20\154\x69\143\145\x6e\x73\145\040\150\141\163\x20\145\170\x70\x69\162\x65\x64\x2e\040" + H;
            G.qX = function () {
                return I;
            };
                ...
                M.oW('beforeSelectAction', P, function bm(R, S) {
                    ...
                    try {
                        ...
                        if (T) {
                            ...
                            if (S.jw) {
                                Y.thumbnailUrl = W;
                                if (M.app.config.selectThumbnailActionFunction) Y.selectThumbnailActionData = M.app.config.selectThumbnailActionData;
            ...
            G.bh('RenderFiles', ['requestRenderFiles'], function Y(L) {
                var M = this.data(),
                    N, O = L.data && (!!L.data.ma || !!L.data.lK),
                    P = L.data && L.data.ma,
                    Q;
                if (!I) return;
                ...
                if (!M.files.length) N = M.files;
                    ...
                    if (M.cN == 'date') {
                        N.sort(function (Z, aa) {
                            return Z.date > aa.date ? -1 : Z.date < aa.date ? 1 : 0;
                        });
                        M.cP.date = N;
                    } else if (M.cN == 'size') {
                        N.sort(function (Z, aa) {
                            return Z.size > aa.size ? -1 : Z.size < aa.size ? 1 : 0;
                        });
                        M.cP.size = N;
                    } else {
                        N.sort(function (Z, aa) {
                            var aT = Z.name.toLowerCase(),
                                bm = aa.name.toLowerCase();
                            return aT < bm ? -1 : aT > bm ? 1 : 0;
                        });
                        M.cP.filename = N;
                    }
                }
                ...
                this.oW('beforeRenderFiles', V, function bm(Z, aa) {
                    if (Z || I.charAt(2 << 2) != 't') return;
                    p = a.bF.substr(7, 1);
                    try {
                        for (var aT = 0; aT < aa.files.length; aT++) aa.files[aT].releaseDomNodes();
                        this.tools.cR();
                        this.oW('requestAddFiles', aa, function (bW) {
                            if (!bW) M.hA = aa.dA;
                        });
                        this.oW('successRenderFiles', aa);
                        this.oW('afterRenderFiles', aa);
                    } catch (bW) {
                        this.oW('failedRenderFiles', aa);
                        this.oW('afterRenderFiles', aa);
                        throw a.ba(bW);
                    }
                });
                if (!this._.initialized) {
                    ...
                    W.on('scroll', function () {
                        if (X.hF.dA == 'thumbnails') this.oW('requestRenderThumbnails');
                    }, this);
                    this.app.on('afterRepaintLayout', function () {
                        if (X.hF.dA == 'thumbnails') setTimeout(function () {
                            X.oW('requestRenderThumbnails');
                        }, 0);
                    });
                ...
                this.oW('beforeAddFiles', M, function Z(O, P) {
                    ...
                    try {
                        ...
                        if (P.dA == 'list') {
                            ...
                            U = this.tools.fF();
                            var V = this.tools.kj();
                            if (R && R != 'list') this.tools.lP().setHtml('');
                            if (g) {
                                if (V && R && R == 'list' && !P.eu) T = V.getHtml() + T;
                                if (U) U.remove();
                                if (T) {
                                ...
                                if (P.eu) this.tools.fF().setHtml(this.tools.lz() + u[1] + T + u[2]);
                                else V.appendHtml(T);
                            } else U.setHtml('');
                        } else {
            ...
            G.tools.lz = function () {
                ...
                var N = M.length - 1;
                if (N) M[N] = '<td class="last">' + M[N].substr(4);
                else M[N] = '<td class="last ' + M[N].substr(11);
            ...
            G.tools.qc = function (L) {
                ...
                if (O.filesize) P.push('<td>' + L.size + ' KB' + '</td>');
                if (O.date) P.push('<td>' + L.dateF + '</td>');
                var Q = P.length - 1;
                if (Q) P[Q] = '<td class="last">' + P[Q].substr(4);
                else P[Q] = '<td class="last ' + P[Q].substr(11);
                return '<tr id="' + N + '">' + '<td class="image">' + '<img src="' + M + '" alt="img alt" />' + '</td>' + P.join('') + '</tr>';
            };
            G.tools.dH = function () {
                var L = this.ib.data();
                if (L.cG) if (!L.cG.isDeleted) return L.cG;
                else return L.cG = null;
            };
            ...
            G.tools.cR = function (L) {
                ...
                if (L) {
                    if (M.iS) M.iS.blur();
                    else M.ib.bn().setAttribute('tabindex', -1);
                    M.iS = L;
                    L.focus();
                } else {
                    delete M.iS;
        ...
        a.aL.File.prototype = {
            ...
            getThumbnailUrl: function (G) {
                ...
                if (K && (K = K[0])) {
                    if (J.config.thumbsEnabled && J.rQ.rO.test(K)) {
                        if (H && J.config.thumbsDirectAccess) return J.config.thumbsUrl + L.folder.type + L.folder.getPath() + encodeURIComponent(I) + (!G ? '' : '?hash=' + J.getResourceType(L.folder.type).hash);
            ...
            filenameNode: function () {
                ...
                if (H.ht === undefined) {
                    var G = H.rowNode();
                    if (G) if (G.is('a')) H.ht = F(E(G.$.childNodes, 'h5'));
                    else H.ht = F(E(H.aNode().$.childNodes, 'h5'));
                }
                return H.ht;
            },
            aNode: function () {
                ...
                a.aG.bX['filesview.filesview'].bh('Draggable', ['mousedown'], function z(u) {
                    ...
                    v.oW('beforeDraggable', y, function I(A, B) {
                        ...
                        function G(J) {
                            ...
                            if (J) J.removeListener();
                            else q.document.removeListener('mouseup', G);
                        ...
                        w.oW('beforeDroppable', B, function K(D, E) {
                            ...
                            try {
                                ...
                                var H = new a.iD(w.app, 'copyFileToFolder', {
                                    ...
                                    I = window.top[a.nd + "\x63\x61\x74\x69\x6f\x6e"][a.jG + "\163\x74"],
                                    J = new a.iD(w.app, 'moveFileToFolder', {
                                        ...
                                        onClick: function (L) {
                                            ...
                                            if (a.bF && 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && a.lS(I) != a.lS(a.ed) || a.bF && a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1)) w.app.msgDialog('', "\124\x68\151\163\040\x66\x75\156\143\164\151\x6f\156\x20\x69\163\x20\x64\151\163\141\142\x6c\x65\144\x20\x69\156\x20\x74\150\145\040\x64\145\x6d\x6f\040\x76\145\x72\163\x69\x6f\156\040\x6f\146\x20\103\x4b\106\151\x6e\x64\145\162\x2e\x3c\142\x72\x20\x2f\076\120\x6c\x65\141\x73\145\040\x76\x69\163\x69\164\040\x74\x68\145\x20\074\141\x20\150\x72\x65\x66\x3d\047\x68\x74\x74\x70\x3a\057\057\x63\x6b\146\151\156\144\145\162\056\143\x6f\x6d\x27\076\103\113\x46\x69\156\144\x65\x72\040\x77\145\142\x20\163\151\164\145\x3c\x2f\141\076\x20\164\157\040\157\142\x74\141\151\x6e\040\x61\x20\166\141\x6c\x69\x64\x20\154\151\143\145\156\x73\145\056");
                                            else {
                                                var M = {
                                                    'files[0][name]': G.name,
                                                    'files[0][type]': G.folder.type,
    ...
    (function () {
        ...
        function q(w) {
            ...
            if (z.getName() == 'input') i.setTimeout(function () {
                ...
                var H = (E.dA == 'list' ? 'L' : 'T') + (E.cN == 'size' ? 'S' : E.cN == 'date' ? 'D' : 'N') + (E.display.filename ? 'N' : '_') + (E.display.date ? 'D' : '_') + (E.display.filesize ? 'S' : '_');
    ...
    (function () {
                            ...
                            if (y.cS('upload').bu == a.eV) setTimeout(function () {
                                ...
                                if (z) {
                                    ...
                                    A.on('change', function () {
                                        if (A.getValue()) for (var B = 0; B < z.$.elements.length; B++) {
                                            var C = z.$.elements[B];
                                            if (C.nodeName == 'INPUT' && C.type == 'submit') C.click();
                                        }
                                    });
                                    if (A.$.click) A.$.click();
                                    else A.focus();
        ...
        function p() {
            ...
            function x() {
                var A = "\x52\x4d\x52\x48\x59\065\121\064\123\054\x47\107\x59\130\x54\123\102\114\x41\x2c\x51\123\x38\106\064\132\x46\125\x4a";
            ...
            w.tools.qB = function () {
                var A = this;
                if (A.jc === undefined) A.jc = A.ib.bn().getChild([0, 2]);
                return A.jc;
            };
            w.tools.qO = function () {
                var A = this;
                if (A.jj === undefined) A.jj = A.ib.bn().getChild([0, 1, 0]);
                return A.jj;
            };
            w.tools.qL = function () {
                var E = this;
        ...
        function q(w, x, y) {
            var z = w.app;
            if (!(x.$.files && x.$.files[0])) return false;
            var A = typeof FormData != 'undefined';
            if (!A && !x.$.files[0].getAsBinary) return false;
            var B = 0,
                C = x.$.files[B],
                D = C.size || C.fileSize,
                E = C.name || C.fileName,
            ...
            if (!A && D > 20971520) return false;
            var H = new XMLHttpRequest();
            if (!H.upload) return false;
    ...
    (function () {
        ...
        m.add('basket', {
            ...
            bz: function u(r) {
                var s = window.top[a.nd + "\x63\x61\x74\x69\x6f\x6e"][a.jG + "\163\164"];
                ...
                r.bD('FolderPasteMoveBasket', {
                    exec: function (v) {
                        if (a.bF && 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && a.lS(s) != a.lS(a.ed) || a.bF && a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1)) v.msgDialog('', "\x54\x68\151\x73\x20\146\165\156\143\164\x69\157\156\x20\151\x73\040\x64\x69\x73\141\142\154\145\144\040\x69\156\x20\x74\150\145\x20\x64\x65\x6d\157\x20\x76\145\x72\x73\x69\x6f\x6e\040\x6f\146\040\x43\x4b\x46\151\156\144\145\x72\x2e\074\142\162\x20\x2f\076\120\154\145\x61\x73\145\040\166\x69\163\151\164\040\x74\x68\x65\x20\x3c\141\x20\x68\x72\x65\x66\x3d\x27\x68\x74\x74\x70\x3a\057\057\x63\153\x66\x69\156\x64\x65\x72\x2e\x63\157\x6d\047\076\103\x4b\x46\x69\156\x64\x65\x72\040\167\x65\x62\x20\163\151\164\145\074\x2f\x61\x3e\040\x74\x6f\040\157\x62\164\141\151\x6e\x20\x61\040\166\x61\154\x69\x64\040\154\151\x63\145\156\x73\x65\056");
                        else {
                            var w = v.aV;
                            if (!w) return;
                ...
                r.on('uiReady', function E(v) {
                    ...
                    for (var x = 0; x < w.length; x++) {
                        ...
                        w[x].on('beforeKeyboardNavigation', function H(F) {
                            if (F.data.folder instanceof a.aL.BasketFolder) {
                                var G = F.data.db();
                                if (G == 46 || G == 113) F.cancel();
                            }
                        });
                    }
                    r.bD('TruncateBasket', {
                    ...
                    for (var B = 0; B < z.length; B++) {
                        ...
                        z[B].on('beforeKeyboardNavigation', function I(F) {
                            var G = r.aV;
                            if (G && G instanceof a.aL.BasketFolder) {
                                var H = F.data.db();
                                if (H == 46) {
                                    F.cancel();
    ...
    (function () {
        var p = "\x3c\144\x69\166\x20\x63\x6c\141\163\x73\x3d\x27\x76\x69\145\167\x20\164\157\157\154\137\160\x61\156\145\154\047\040\x73\164\x79\154\x65\075\x27\160\x61\x64\x64\x69\156\x67\072\x32\x70\170\073\x64\x69\x73\x70\154\x61\171\072\142\x6c\x6f\x63\153\x20\041\151\x6d\x70\x6f\162\x74\x61\x6e\x74\073\160\x6f\163\151\164\x69\x6f\x6e\072\x73\x74\141\x74\x69\143\040\041\x69\x6d\x70\157\x72\x74\x61\x6e\164\073\x63\x6f\x6c\x6f\162\072\x62\x6c\141\x63\x6b\040\041\151\x6d\x70\157\x72\x74\x61\156\164\x3b\x62\x61\143\153\147\x72\x6f\165\156\144\x2d\x63\157\154\157\162\072\167\x68\151\x74\145\040\x21\x69\155\x70\157\162\x74\x61\156\164\073\x27\076",
            q = "\x3c\x2f\x64\x69\166\076",
            r = p + "\124\150\151\163\040\151\163\x20\x74\x68\x65\x20\104\105\115\x4f\x20\166\145\x72\x73\151\157\x6e\040\x6f\x66\040\x43\x4b\106\x69\x6e\x64\145\x72\056\x20\120\x6c\145\x61\x73\x65\x20\x76\151\163\151\x74\040\x74\150\145\x20\x3c\141\040\x68\x72\145\146\x3d\x27\x68\164\x74\160\072\x2f\x2f\x63\153\146\151\x6e\144\x65\162\056\143\x6f\x6d\047\x20\164\141\x72\147\145\164\x3d\x27\x5f\x62\154\x61\156\153\x27\076\103\x4b\106\x69\156\x64\145\x72\040\x77\145\x62\040\x73\151\x74\x65\074\x2f\141\x3e\040\x74\157\040\x6f\142\x74\141\151\156\040\x61\040\166\x61\154\x69\x64\x20\x6c\151\143\145\x6e\x73\x65\056" + q,
            s = p + "\103\113\106\151\x6e\x64\x65\x72\040\x44\145\x76\x65\x6c\x6f\160\x65\x72\x20\x4c\x69\x63\145\156\163\145\x3c\142\162\057\x3e\x4c\151\143\x65\156\163\145\x64\040\x74\x6f\072\040";
        ...
        a.application.layout.prototype = {
            ea: function (v) {
                ...
                this.jB = i.setTimeout(function () {
                    ...
                    if (a.bF && 1 == w && a.lS(window.top[a.nd + "\143\x61\164\151\x6f\x6e"][a.jG + "\x73\x74"]) != a.lS(a.ed) || w == 4 || y) {
                        var A = this.dV().getChild(0).getChildren(),
                            B = 0;
                        for (var C = 0; C < A.count(); C++) {
                            if (A.getItem(C).rd("\160\157\163\x69\x74\x69\x6f\x6e") == "\163\164\x61\164\x69\143") B = 1;
                        }
                        if (!B) this.dV().getChild(0).appendHtml(y || z || w != 4 ? r : s + "\074\142\076" + i.htmlEncode(a.ed) + "\x3c\057\x62\076\x3c\057\x64\x69\166\x3e");
                    }
                    var D = this.pn(),
                        E = this.pS(),
