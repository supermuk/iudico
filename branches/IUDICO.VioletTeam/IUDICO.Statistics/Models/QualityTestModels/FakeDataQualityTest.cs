...
namespace IUDICO.Statistics.Models.QualityTest
{
    public static class FakeDataQualityTest
    {
        ...
        public static String FakeCurriculumName(long selectCurriculumId)
        {
            return "Програмування";
        }
        // SelectGroups
        public static String FakeThemeName(int selectThemeId)
        {
            return "Тема1";
        }
        ...
        public static AttemptResult GetFakeAttempt(User user, Theme theme)
        {
            float? attemptScore;
            switch (user.Username)
            {
                ...
                case "Остап Андрусів(08i301)":
                    ...
                    return new AttemptResult(1, user, theme, new CompletionStatus(), new AttemptStatus(), new SuccessStatus(), DateTime.Now, attemptScore);
                ...
                case "Ігор Михалевич(08i125)":
                    ...
                    return new AttemptResult(1, user, theme, new CompletionStatus(), new AttemptStatus(), new SuccessStatus(), DateTime.Now, attemptScore);
                default:
                    return new AttemptResult(-1, user, theme, new CompletionStatus(), new AttemptStatus(), new SuccessStatus(), DateTime.Now, (float?)1.0);
            }
        }
