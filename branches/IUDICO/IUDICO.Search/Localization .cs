...
namespace IUDICO.Search
{
    public class Localization : System.Web.Mvc.ViewPage
    {
        ...
        {
            string path = HttpContext.Current.Server.MapPath("/").Replace("IUDICO.LMS", "IUDICO.Search");
            ResXResourceReader rsxr = new ResXResourceReader(path + "Resource" + ".en-US.resx");
            ...
            rsxr = new ResXResourceReader(path + "Resource" + ".uk-UA" + ".resx");
