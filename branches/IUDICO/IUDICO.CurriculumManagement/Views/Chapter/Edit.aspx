...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2><%=IUDICO.CurriculumManagement.Localization.getMessage("EditChapter")%></h2>
    <% Html.EnableClientValidation(); %>
    <h4><%=ViewData["DisciplineName"]%><%=IUDICO.CurriculumManagement.Localization.getMessage("Next")%><%=Model.Name%></h4>
    ...
    <div>
        <br />
        <%: Html.RouteLink(IUDICO.CurriculumManagement.Localization.getMessage("BackToList"), "Chapters", new { action = "Index", DisciplineId = HttpContext.Current.Session["DisciplineId"] })%>
    </div>
