...
namespace CompileSystem.Compiling.Run
{
    /// <summary>
    /// 
    /// </summary>
    public class Runner
    {
        ...
        /// </remarks>
        private static readonly string NETWrapperPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, @"Bin\Helper.DotNetExeWrapper.exe");
        ...
        /// </remarks>
        private static readonly string JavaWrapperPath = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, @"Compilers\Java6\bin\java.exe");
        ...
        public static Result ExecuteWin32(string exePath, Program program, string arguments)
        {
            ...
            var result = new Result {ProgramStatus = Status.Running};
        ...
        public static Result Execute(string exePath, Program program)
        {
            ...
            if (program.Language == Language.Java6)
            {
                return ExecuteWin32(JavaWrapperPath, program,
                                    "-cp " + "\"" + Path.GetDirectoryName(exePath) + "\" " +
