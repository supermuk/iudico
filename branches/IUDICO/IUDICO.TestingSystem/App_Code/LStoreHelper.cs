// --------------------------------------------------------------------------------------------------------------------
// <copyright company="" file="LStoreHelper.cs">
//   
// </copyright>
// 
// --------------------------------------------------------------------------------------------------------------------
...
namespace LearningComponentsHelper
{
    ...
    public static partial class LStoreHelper
    {
        ...
        /// <param name="result">Where to store the result.</param>
        ///
        public static void CastNonNull(object value, out LearnerGlobalObjectiveItemIdentifier result)
        {
            LearningStoreItemIdentifier id;
            CastNonNull(value, out id);
        ...
        /// <param name="result">Where to store the result.</param>
        ///
        public static void CastNonNull(object value, out MapActivityObjectiveToGlobalObjectiveItemIdentifier result)
        {
            LearningStoreItemIdentifier id;
            CastNonNull(value, out id);
