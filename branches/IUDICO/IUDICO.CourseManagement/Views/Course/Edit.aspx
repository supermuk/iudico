...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h2><%=CourseManagRes.CourseManagement.Edit%></h2>
    ...
    <% using (Html.BeginForm()) {%>
        ...
        <fieldset>
            ...
            <% }%>
            <%  foreach (IUDICO.Common.Models.User user in ViewData["SharedUsers"] as IEnumerable<IUDICO.Common.Models.User>)
                { %>
            ...
            <p>
                <input type="submit" value=<%=CourseManagRes.CourseManagement.Save%> />
            </p>
        </fieldset>
