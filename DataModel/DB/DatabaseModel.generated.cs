...
namespace IUDICO.DataModel.DB
{
    ...
    partial void DeleteTblUsers(TblUsers instance);
		...
		public System.Data.Linq.Table<TblCompiledAnswersData> TblCompiledAnswersData
		{
			get
			{
				return this.GetTable<TblCompiledAnswersData>();
			}
		}
    ...
    partial void OnSysStateChanged();
		...
		{
			this.SendPropertyChanging();
			entity.TblCompiledAnswers = this;
		}
		
		private void detach_TblUserAnswers(TblUserAnswers entity)
		{
			this.SendPropertyChanging();
			entity.TblCompiledAnswers = null;
		}
	}
	...
	public partial class TblCompiledAnswersData
	{
		...
		[Column(Storage="_UserRef", AutoSync=AutoSync.Always, DbType="Int NOT NULL IDENTITY", IsDbGenerated=true)]
		public int UserRef
		{
			get
			{
    ...
    partial void OnSysStateChanged();
		...
		{
			this._TblCompiledAnswers = default(EntityRef<TblCompiledAnswers>);
		...
		public System.Nullable<int> CompiledAnswerRef
		{
			...
			set
			{
				...
				{
					if (this._TblCompiledAnswers.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnCompiledAnswerRefChanging(value);
					this.SendPropertyChanging();
					this._CompiledAnswerRef = value;
					this.SendPropertyChanged("CompiledAnswerRef");
					this.OnCompiledAnswerRefChanged();
				}
			}
		}
		...
		public TblCompiledAnswers TblCompiledAnswers
		{
			get
			{
				return this._TblCompiledAnswers.Entity;
			}
			set
			{
				TblCompiledAnswers previousValue = this._TblCompiledAnswers.Entity;
				if (((previousValue != value) 
							|| (this._TblCompiledAnswers.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._TblCompiledAnswers.Entity = null;
						previousValue.TblUserAnswers.Remove(this);
					}
					this._TblCompiledAnswers.Entity = value;
					if ((value != null))
					{
						value.TblUserAnswers.Add(this);
						this._CompiledAnswerRef = value.ID;
					}
					else
					{
						this._CompiledAnswerRef = default(Nullable<int>);
					}
					this.SendPropertyChanged("TblCompiledAnswers");
				}
			}
		}
