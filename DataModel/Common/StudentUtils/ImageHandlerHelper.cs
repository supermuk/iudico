...
namespace IUDICO.DataModel.Common.StudentUtils
{
    public class ImageHandlerHelper
    {
        ...
        private const string ImageFileRequest = HandlerPaths.ImageHandlerPath + "?" + ImageIdRequestParameter + "=";
        ...
        public static int GetImageIdFromRequest(HttpRequest request)
        {
            return int.Parse(request[ImageIdRequestParameter]);
        }
