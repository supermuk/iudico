...
namespace IUDICO.DataModel.Controllers
{
    public class CurriculumTimelineController : ControllerBase
    {
        ...
        public Label CurriculumForGroupLabel { get; set; }
        ...
        public void PageLoad(object sender, EventArgs e)
        {
            ...
            {
                if (groupID == -1 || curriculumID == -1)
                {
                    CurriculumForGroupLabel.Text = "Sorry you came here from wrong place";
                ...
                else
                {
                    ...
                    CurriculumForGroupLabel.Text = "Assigning curriculum: " + curriculum.Name +
