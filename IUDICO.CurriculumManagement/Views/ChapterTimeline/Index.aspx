...
Inherits="System.Web.Mvc.ViewPage<IEnumerable<IUDICO.CurriculumManagement.Models.ViewDataClasses.ViewChapterTimelineModel>>" %>
    ...
    <script type="text/javascript" language="javascript">
        $(document).ready(function () {
            $("#DeleteMany").click(function () {
                ...
                $.ajax({
                    type: "post",
                    url: "/ChapterTimeline/DeleteItems",
        ...
        function deleteItem(id) {
            ...
            $.ajax({
                type: "post",
                url: "/ChapterTimeline/DeleteItem",
                data: { timelineId: id },
                success: function (r) {
                    if (r.success == true) {
                        var item = "item" + id;
