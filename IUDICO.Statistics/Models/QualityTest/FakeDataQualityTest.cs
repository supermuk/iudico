        ...
        public static AttemptResult GetFakeAttempt(User user, Theme theme)
        {
            ...
            switch (user.Username)
            {
                ...
                case "Остап Андрусів(08i301)":
                    ...
                    return new AttemptResult(1, user, theme, new CompletionStatus(), new AttemptStatus(), new SuccessStatus(), attemptScore);
                ...
                case "Ігор Михалевич(08i125)":
                    ...
                    return new AttemptResult(1, user, theme, new CompletionStatus(), new AttemptStatus(), new SuccessStatus(), attemptScore);
                default:
                    return new AttemptResult(-1, user, theme, new CompletionStatus(), new AttemptStatus(), new SuccessStatus(), (float?)1.0);
            }
        }
